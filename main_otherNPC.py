...
loconame_panam_stand = "wa_judy_unarmed_locomotion_relaxed.anims"
loconame_genfem_crouch = "wa_gang_unarmed_locomotion_stealth.anims"

prefix_panam_folder_stand = "0_judyPOSE_S_"
prefix_panam_folder_crouch = "0_judyPOSE_C_"
...
def locomotion_convertor():
    ...
    for folder in os.listdir(dir_output_unbundled):
        ...
        loc_path_stand = "\\base\\animations\\npc\\main_characters\\judy\\locomotion"
